...
const REPORTS = [
  {
    id: '05',
    title: 'Performance do Período 4 — o controle que o R04 pediu foi feito, e respondeu',
    desc: 'Performance 18/08 a 04/09',
    date: '2026-09-04',
    tags: ['R$ 1.550 investidos', '225 leads', 'CPL R$ 6,89', '16 vendas', 'pixel ligado'],
    highlight: 'AD 11 + VSL entregou o melhor CPL da história (R$ 5,81) e a conversão voltou a 7,1% — era a página, não o criativo. O mesmo anúncio custou metade sozinho em conjunto aberto 1-1-1. O pixel passou a ver compras (11, R$ 483). Mas metade das 16 vendas está no CRM sem valor, e o vencedor está pausado.',
    html: require('./reports/r05-performance-p4'),
  },
  {
    id: '04',
    title: 'Performance do Período 3 — três mudanças ao mesmo tempo',
    desc: 'Performance 07/08 a 17/08',
    date: '2026-08-17',
    tags: ['R$ 756 investidos', '63 leads', 'CPL R$ 12,01', '2 vendas', '7 defeitos de dados'],
    highlight: 'Desta vez a maturidade NÃO explica: mesmo com a coorte 75% mais velha e o fator 1,81×, a receita projetada é R$ 144 contra R$ 756 gastos. Mas a causa é indeterminável — página e criativo mudaram no mesmo dia. O webinar não chegou a acontecer: zero inscritos, zero tráfego apontado pra página.',
    html: require('./reports/r04-performance-p3'),
  },
  {
    id: '03',
