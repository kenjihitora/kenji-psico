...
// v2 (28/jul, fim do dia): + venda da Marcionila (AD 03 CBO 111) e gasto/funil repuxados no mesmo instante.
...
<header>
  ...
  <p class="lede">Varredura completa cruzando Meta Marketing API (gasto, CPC, CTR, hook, body por campanha/AD), o banco do funil (1.377 sessões, passagem tela a tela) e o CRM (129 leads reais, 17 compradores com produto atribuído). Todos os CPLs foram <b>recalculados na mão</b> cruzando <code>utm_campaign + utm_content</code> — o cruzamento só por nome duplicava leads entre campanhas.</p>
  <div class="meta-row">
    <span>Período <b>16–28 jul 2026</b></span>
    <span>Investimento <b>R$ 2.080,97</b></span>
    <span>Leads reais <b>129</b> (sem teste)</span>
    <span>Vendas CRM <b>17 · R$ 1.531,70</b></span>
    <span>Fuso <b>Brasília</b></span>
  </div>
  <div class="callout" style="margin-top:18px">🆕 <b>Versão 2 — 28/jul, fim do dia.</b> Entrou a venda da <b>Marcionila</b> (Fundamentos + Metas, R$ 69,80, fechada pelo comercial) vinda do <b>AD 03 CBO 111</b>. Gasto e funil foram repuxados no mesmo instante, então o relatório inteiro é um snapshot coerente. <b>Duas conclusões mudaram de patamar:</b> o AD 03 passou a se pagar sozinho no front (ROAS 1,07) e a CBO solo — que era “cedo demais” — já tem venda.</div>
</header>

<section>
  <div class="grid g3">
    <div class="tile"><div class="n">R$ 1.531,70</div><div class="l">Receita atribuída (CRM)</div><div class="s">o pixel só enxergou R$ 307 — 41% das vendas</div></div>
    <div class="tile"><div class="n">0,74</div><div class="l">ROAS front blended</div><div class="s">front recupera 74% do tráfego antes da esteira</div></div>
    <div class="tile"><div class="n">R$ 90,10</div><div class="l">Ticket médio por comprador</div><div class="s">attach do bump: 44% · upsell Pilares: 2 de 17</div></div>
    <div class="tile"><div class="n">21,4%</div><div class="l">Passam da tela de início</div><div class="s">79% do tráfego pago morre antes do quiz</div></div>
    <div class="tile"><div class="n">7 <span style="font-size:15px;color:var(--muted)">de 17</span></div><div class="l">Vendas vêm do AD 03</div><div class="s">R$ 656,10 · <b>ROAS front 1,07 — se paga sozinho</b></div></div>
    <div class="tile"><div class="n">8 <span style="font-size:15px;color:var(--muted)">de 8</span></div><div class="l">Vendas do comercial vêm de AD 03 + 01 + 04</div><div class="s">100% · lead do AD 06 só compra sozinho</div></div>
  </div>
</section>
...
<section>
  ...
  <div class="card" style="margin-top:12px">
    <div class="finding"><span class="tag">CAMPEÃO</span><p><b>AD 03 é o criativo validado do funil — e agora ele se paga.</b> 7 das 17 vendas, R$ 656,10, presente em 4 campanhas. Somando todo o gasto dele (R$ 615,35), o <b>ROAS front é 1,07</b>: o criativo devolve o investimento <i>antes</i> de esteira, upsell e mentoria. Tudo que vier depois é margem.</p></div>
    <div class="finding"><span class="tag">POR QUÊ</span><p><b>Ele não vence em nenhuma métrica de topo.</b> Hook médio (10–23%), CPC caro (R$ 3,45–6,51). Onde ele esmaga: <b>qualidade do clique</b> — 34–47% de start rate no quiz e a melhor passagem até a VSL. Quem clica no AD 03 vem <i>pra fazer o teste</i>. Congruência anúncio→página vale mais que hook bonito.</p></div>
    ...
    <div class="finding"><span class="tag">ABO×CBO</span><p><b>Pro AD 03, a CBO paga clique mais caro e vende 2,5× mais.</b> CPC na CBO chegou a ser 89% maior que na ABO — e mesmo assim entregou <b>5 das 7 vendas</b> e <b>ROAS front 1,43 contra 0,44 da ABO</b> (3,3× melhor). A entrega da CBO encontra comprador; a da ABO encontra clicador. Clique barato ≠ lead que compra.</p></div>
    <div class="finding"><span class="tag">COMERCIAL</span><p><b>100% das vendas do comercial vêm de AD 03, AD 01 e AD 04</b> — 8 de 8 fechadas na mão. O AD 06, justamente o de CPL mais barato, tem <b>zero</b>: o lead dele compra self-service ou não compra. Fila de abordagem tem dono.</p></div>
    <div class="finding"><span class="tag">TRACKING</span><p><b>Tracking sujo já custou atribuição real:</b> a maior compradora da base (R$ 346,90, Fundamentos + Pilares) veio de campanha com UTM literal <code>{{ad.name}}</code> sem preencher. E o Purchase do pixel só bate com 41% das vendas do CRM — otimizar campanha por pixel hoje é dirigir olhando um retrovisor embaçado.</p></div>
  </div>
</section>
...
<section>
  ...
  <table>
    ...
    <tbody>
      <tr class="champ"><td class="adname">AD 03 🏆</td><td class="num"><b>7</b></td>
        <td><div style="display:flex;align-items:center;gap:8px"><b style="white-space:nowrap">R$ 656,10</b><div class="bar" style="flex:1"><i class="g" style="width:100%"></i></div></div></td>
        <td class="num">5</td><td class="num">2</td><td class="num">R$ 93,73</td><td class="num">R$ 615,35</td><td class="num">R$ 87,91</td><td class="num up">1,07</td></tr>
      <tr><td class="adname">AD 01</td><td class="num"><b>3</b></td>
        <td><div style="display:flex;align-items:center;gap:8px"><b style="white-space:nowrap">R$ 189,50</b><div class="bar" style="flex:1"><i class="g" style="width:29%"></i></div></div></td>
        <td class="num">2</td><td class="num">1</td><td class="num">R$ 63,17</td><td class="num">R$ 272,18</td><td class="num">R$ 90,73</td><td class="num">0,70</td></tr>
      <tr><td class="adname">AD 06</td><td class="num"><b>2</b></td>
        <td><div style="display:flex;align-items:center;gap:8px"><b style="white-space:nowrap">R$ 99,80</b><div class="bar" style="flex:1"><i class="g" style="width:15%"></i></div></div></td>
        <td class="num">0</td><td class="num">2</td><td class="num">R$ 49,90</td><td class="num">R$ 273,83</td><td class="num">R$ 136,92</td><td class="num down">0,36</td></tr>
      <tr><td class="adname">AD 04</td><td class="num">1</td>
        <td><div style="display:flex;align-items:center;gap:8px"><b style="white-space:nowrap">R$ 69,80</b><div class="bar" style="flex:1"><i class="g" style="width:11%"></i></div></div></td>
      ...
      <tr><td class="adname">AD 05</td><td class="num">1</td>
        <td><div style="display:flex;align-items:center;gap:8px"><b style="white-space:nowrap">R$ 49,90</b><div class="bar" style="flex:1"><i class="g" style="width:8%"></i></div></div></td>
      ...
      <tr><td class="adname dim">{{ad.name}} ⚠️</td><td class="num">1</td>
        <td><div style="display:flex;align-items:center;gap:8px"><b style="white-space:nowrap">R$ 346,90</b><div class="bar" style="flex:1"><i class="g" style="width:53%"></i></div></div></td>
      ...
      <tr><td class="adname dim">AD 02 · AD 07 · AD 09 · AD 01-Cópia</td><td class="num">0</td><td class="dim">—</td><td class="num">0</td><td class="num">0</td><td class="num dim">—</td><td class="num">R$ 397,00</td><td class="num dim">∞</td><td class="num down">0,00</td></tr>
      <tr class="total"><td>TOTAL</td><td class="num">17</td><td><b>R$ 1.531,70</b></td><td class="num">8</td><td class="num">9</td><td class="num">R$ 90,10</td><td class="num">R$ 2.080,97</td><td class="num">R$ 122,41</td><td class="num">0,74</td></tr>
    </tbody>
  </table>
  </div>
  <div class="callout" style="margin-top:14px">💡 <b>Mix de produtos nas 17 vendas:</b> Fundamentos 16× (R$ 798,40) · Metas em Movimento 7× (R$ 139,30) · Pilares 2× (R$ 594,00). O <b>bump tem 44% de attach</b> (7 de 16 que levaram o Fundamentos) — está funcionando e subiu com a última venda. O Pilares aparece em só 2 vendas mas responde por 39% da receita: <b>o dinheiro está no degrau de cima</b>, exatamente a tese da esteira.</div>
...
<section>
  ...
  <div class="qa">
    ...
    <span class="a-short">CPC melhor na ABO · Hook melhor na CBO — e a CBO é onde ele vende (5 das 7)</span>
    <div class="tblwrap">
    <table>
      ...
      <tbody>
        ...
        <tr><td class="adname">ABO V2 FRIO</td><td class="num">7</td><td class="num">R$ 163,29</td><td class="num">R$ 4,54</td><td class="num">1,96%</td><td class="num">19,7%</td><td class="num">2,13%</td><td class="num">6</td><td class="num down">R$ 27,22</td><td class="num">1</td></tr>
        <tr class="champ"><td class="adname">CBO V3 (1-1-5)</td><td class="num">4</td><td class="num">R$ 286,33</td><td class="num down">R$ 6,51</td><td class="num">2,02%</td><td class="num up">22,7%</td><td class="num up">2,75%</td><td class="num"><b>20</b></td><td class="num">R$ 14,32</td><td class="num"><b>4</b> (3 com. + 1)</td></tr>
        <tr class="champ"><td class="adname">CBO solo (1-1-1)</td><td class="num">1</td><td class="num">R$ 103,58</td><td class="num">R$ 5,18</td><td class="num">1,35%</td><td class="num">15,4%</td><td class="num">2,23%</td><td class="num">11</td><td class="num up">R$ 9,42</td><td class="num"><b>1</b> (com.) 🆕</td></tr>
      </tbody>
    </table>
    </div>
    <p><b>Leitura de CRO sênior:</b> a ABO comprou o clique mais barato (R$ 3,45) e o hook mais fraco; a CBO 1-1-5 pagou o clique mais caro da série (R$ 6,51, +89%) e mesmo assim entregou CPL menor e concentrou 4 vendas. Somando os dois formatos, a conclusão fica difícil de contestar:</p>
    <div class="grid g2" style="margin-top:6px">
      <div class="card"><h3 style="margin-top:0">AD 03 na ABO</h3>
        <div class="barrow"><span class="lab">Gasto</span><div class="bar"><i style="width:58%"></i></div><span class="val">R$ 225,44</span></div>
        <div class="barrow"><span class="lab">Leads</span><div class="bar"><i style="width:29%"></i></div><span class="val">9</span></div>
        <div class="barrow"><span class="lab">CPL</span><div class="bar"><i style="width:50%"></i></div><span class="val">R$ 25,05</span></div>
        <div class="barrow"><span class="lab">Vendas</span><div class="bar"><i style="width:40%"></i></div><span class="val">2</span></div>
        <div class="barrow"><span class="lab">ROAS front</span><div class="bar"><i style="width:31%"></i></div><span class="val down">0,44</span></div>
      </div>
      <div class="card"><h3 style="margin-top:0">AD 03 na CBO</h3>
        <div class="barrow"><span class="lab">Gasto</span><div class="bar"><i class="t" style="width:100%"></i></div><span class="val">R$ 389,91</span></div>
        <div class="barrow"><span class="lab">Leads</span><div class="bar"><i class="t" style="width:100%"></i></div><span class="val">31</span></div>
        <div class="barrow"><span class="lab">CPL</span><div class="bar"><i class="t" style="width:100%"></i></div><span class="val up">R$ 12,58</span></div>
        <div class="barrow"><span class="lab">Vendas</span><div class="bar"><i class="t" style="width:100%"></i></div><span class="val">5</span></div>
        <div class="barrow"><span class="lab">ROAS front</span><div class="bar"><i class="t" style="width:100%"></i></div><span class="val up">1,43</span></div>
      </div>
    </div>
    <p style="margin-top:12px">Mesmo pagando <b>clique mais caro</b>, a CBO entrega <b>CPL 50% menor</b>, <b>3,4× mais leads</b> e um <b>ROAS front 3,3× maior</b> — só ela devolve o investimento. O leilão da CBO acha um público que <i>entra e completa o quiz</i>; o da ABO acha quem clica e vaza. <b>O CPC isolado teria levado à conclusão exatamente oposta.</b> E a CBO solo, com 1 dia de vida, já é a linha de melhor CPL do relatório (R$ 9,42) e o melhor start rate do funil inteiro (47,4%) — <i>e já vendeu</i>.</p>
  </div>

  <div class="qa">
    <p class="q">“Qual AD, mesmo com menos vendas, trouxe o melhor CPL?”</p>
    <span class="a-short">AD 06 — R$ 10,14 por lead. Mas o AD 03 na CBO solo já chegou em R$ 9,42</span>
    <p>O AD 06 gerou <b>27 leads a R$ 10,14 de média</b> (R$ 9,76 na ABO V2) — bem abaixo do CPL geral de R$ 16,13. Mas veja o contraste de qualidade: cada lead do AD 06 vale <b>R$ 3,70 em receita</b>, contra <b>R$ 16,40 por lead do AD 03</b> (4,4× mais). E o título de melhor CPL acabou de mudar de dono: a <b>CBO solo do AD 03 fez R$ 9,42</b> — ou seja, o campeão de vendas agora também é o campeão de custo. Menção honrosa: AD 05 na CBO fez R$ 8,48, porém com 4 leads — micro-amostra, não dá pra afirmar nada.</p>
  ...
  <div class="qa">
    ...
    <span class="a-short">Sim — AD 03 (5×2) e AD 01 (2×1). E o AD 06 é o oposto: 0 pelo comercial</span>
    ...
    <div>
      <div class="barrow"><span class="lab">AD 03</span><div class="pair"><i class="c" style="width:71.4%"></i><i class="d" style="width:28.6%"></i></div><span class="val">5 · 2</span></div>
    ...
    <p><b>Insight operacional:</b> o lead que veio de AD 03/AD 01 <i>atende e fecha no WhatsApp</i> — <b>88% das vendas do comercial saem desses dois</b>, e 100% delas saem de AD 03 + AD 01 + AD 04. Nenhum outro criativo produziu uma única venda por abordagem. O lead do AD 06 ignora abordagem (ou não foi abordado — vale conferir com o Kalebe). Direcionar a energia do comercial por origem de AD é ganho imediato e grátis.</p>
  </div>
  ...
  <div class="qa">
    ...
    <div class="grid g2" style="margin-top:8px">
      <div class="card">
        ...
        <div class="barrow"><span class="lab">AD 06 · CBO solo</span><div class="bar"><i style="width:63%"></i></div><span class="val">R$ 2,06</span></div>
...
<section>
  ...
  <div class="grid g2" style="margin-top:12px">
    <div class="card">
      ...
      <div class="barrow"><span class="lab">AD 03 CBO 111</span><div class="bar"><i style="width:100%"></i></div><span class="val">47,4%</span></div>
      <div class="barrow"><span class="lab">AD 06</span><div class="bar"><i style="width:80%"></i></div><span class="val">38,0%</span></div>
      <div class="barrow"><span class="lab">link_in_bio</span><div class="bar"><i style="width:74%"></i></div><span class="val">35,0%</span></div>
      <div class="barrow"><span class="lab">AD 03</span><div class="bar"><i style="width:72%"></i></div><span class="val">34,2%</span></div>
      <div class="barrow"><span class="lab">AD 09</span><div class="bar"><i style="width:54%"></i></div><span class="val">25,5%</span></div>
      <div class="barrow"><span class="lab">AD 08</span><div class="bar"><i style="width:51%"></i></div><span class="val">24,0%</span></div>
      <div class="barrow"><span class="lab">AD 06 CBO 111</span><div class="bar"><i style="width:50%"></i></div><span class="val">23,8%</span></div>
      <div class="barrow"><span class="lab">AD 05</span><div class="bar"><i style="width:44%"></i></div><span class="val">21,0%</span></div>
      <div class="barrow"><span class="lab">AD 02 Cópia Adv.</span><div class="bar"><i style="width:29%"></i></div><span class="val">13,6%</span></div>
      ...
      <div class="barrow"><span class="lab">AD 02</span><div class="bar"><i style="width:26%"></i></div><span class="val">12,2%</span></div>
...
<section>
  ...
  <div class="grid g2" style="margin-top:12px">
    <div class="card">
      ...
      <div class="barrow"><span class="lab">Indeciso</span><div class="bar"><i style="width:26%"></i></div><span class="val">5,0%</span></div>
      <p style="font-size:13px;color:var(--muted);margin-top:10px">Com a venda da Marcionila, o <b>Perfeccionista assumiu a liderança em receita</b> (R$ 536,40 contra R$ 516,50 do Sobrecarregado) — ele é o perfil de ticket alto (é dele o Pilares de R$ 297). O Sobrecarregado ainda converte mais em proporção. O Indeciso quase não compra — ironicamente coerente com o perfil (“e se eu escolher errado?”).</p>
    </div>
    <div class="card">
      ...
      <p style="font-size:13px;color:var(--muted);margin-top:10px">A Marcionila (55+, Perfeccionista, IG Feed) colocou o <b>55 ou mais na liderança</b>: 6 dos 17 compradores. <b>35+ compra ~2× mais que &lt;35</b> (15,4% contra 7,9%) — e 51% da base já tem 45+. Compradores: 10 mulheres / 7 homens. Placement das vendas: IG Feed 6 · IG Reels 5 · IG Stories 3 · FB Reels 2 — Stories converte acima do peso.</p>
    </div>
  </div>
</section>
...
<section>
  ...
  <table style="min-width:900px">
    ...
    <tbody>
      <tr><td class="dim">ABO V2 FRIO</td><td class="adname">AD 06</td><td class="num">224,38</td><td class="num">23</td><td class="num up">9,76</td><td class="num">3,74</td><td class="num">1,52%</td><td class="num">17,4%</td><td class="num">1,75%</td><td class="num">2</td><td class="num">99,80</td></tr>
      <tr><td class="dim">ABO V2 FRIO</td><td class="adname">AD 01</td><td class="num">180,82</td><td class="num">7</td><td class="num">25,83</td><td class="num">3,93</td><td class="num">1,02%</td><td class="num">23,7%</td><td class="num">1,44%</td><td class="num">1</td><td class="num">69,80</td></tr>
      <tr><td class="dim">ABO V2 FRIO</td><td class="adname">AD 03</td><td class="num">163,29</td><td class="num">6</td><td class="num">27,22</td><td class="num">4,54</td><td class="num">1,96%</td><td class="num">19,7%</td><td class="num">2,13%</td><td class="num">1</td><td class="num">49,90</td></tr>
      ...
      <tr class="champ"><td class="dim">CBO solo AD 03</td><td class="adname">AD 03 CBO 111</td><td class="num">103,58</td><td class="num">11</td><td class="num up"><b>9,42</b></td><td class="num">5,18</td><td class="num">1,35%</td><td class="num">15,4%</td><td class="num">2,23%</td><td class="num"><b>1</b> 🆕</td><td class="num">69,80</td></tr>
      <tr><td class="dim">CBO solo AD 06</td><td class="adname">AD 06 CBO 111</td><td class="num">49,45</td><td class="num">4</td><td class="num">12,36</td><td class="num up">2,06</td><td class="num">1,74%</td><td class="num">16,7%</td><td class="num">1,59%</td><td class="num dim">1d</td><td class="num dim">—</td></tr>
    </tbody>
  </table>
  </div>
</section>
...
<section>
  ...
  <div class="card" style="margin-top:12px">
    ...
    <div class="finding"><span class="tag">PIXEL 41%</span><p><b>O Purchase do pixel viu 7 vendas (R$ 307)</b>; o CRM tem 17 (R$ 1.532) — e a distância só cresce a cada venda fechada pelo comercial, que o pixel nunca vai enxergar. Com match de 41%, otimizar campanha por Purchase ainda é cedo: o evento Lead (que dispara no funil) segue sendo o sinal mais confiável pro leilão.</p></div>
...
<section>
  ...
  <div class="card plan" style="margin-top:12px">
    <div class="item"><span class="prio p0">P0</span><p><b>Escalar o AD 03 na CBO solo — a recomendação acabou de ser validada.</b> Com 1 dia de vida ela já tem o melhor CPL do relatório (R$ 9,42), o melhor start rate do funil (47,4%) <i>e a primeira venda</i>. Subir orçamento em degraus de 20–30% e deixar 3–4 dias sem mexer entre eles (1 dia de dado ainda é leilão aprendendo).</p></div>
    <div class="item"><span class="prio p0">P0</span><p><b>Comercial com mira:</b> priorizar abordagem nos leads de <b>AD 03 e AD 01</b> (88% das vendas do comercial; 100% se incluir o AD 04) e nos perfis <b>Sobrecarregado / Perfeccionista 35+</b> — a faixa <b>55+</b> virou a de melhor conversão (17,6%). Leads de AD 06 vão pra régua de nutrição, não pra fila de ligação.</p></div>
