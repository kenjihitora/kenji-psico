...
<section>
  <div class="grid g3">
    ...
    <div class="tile"><div class="n">R$ 39,90</div><div class="l">Receita atribuída</div><div class="s">ROAS 0,05</div></div>
    <div class="tile"><div class="n">0</div><div class="l">Inscritos no webinar</div><div class="s">a página nunca recebeu tráfego</div></div>
  </div>
</section>
...
<section>
  ...
  <p>Já o <b>AD 06</b> se comportou exatamente como o R03 descreveu: maior volume de leads (24) e a única venda do período — <b>fechada pelo comercial</b>, não no direto. Continua sendo o anúncio que enche a base e entrega ao time, não o que vende sozinho.</p>
</section>
...
<section>
  <h2>8. O webinar: zero inscritos</h2>
  <p>A página <code>/webinar</code> subiu em 11/ago às 22h09 e o evento aconteceu em 15/ago às 14h. Ela captou <b>zero inscrições</b>.</p>
  <h3>Como eu verifiquei, e o que descartei</h3>
  <div class="card">
  ...
  <div class="callout bad"><b>Ressalva:</b> não submeti um cadastro de teste em produção, então a verificação é estrutural, não ponta a ponta. Dado que o endpoint está comprovadamente recebendo dados e a página não tem erro, a probabilidade de bug é baixa — mas se você quiser certeza absoluta antes de reusar a página, um envio de teste (e depois marcar o lead como 🧪) resolve em um minuto.</div>
  <p><b>A página segue no ar hoje</b>, captando inscrição para um evento que já passou, com o contador travado em "A aula está começando". Decidir o destino dela — reaproveitar, virar replay ou tirar do ar — é a pendência mais visível do projeto.</p>
</section>
...
<section>
  ...
  <table>
    ...
    <tbody>
      <tr class="alerta"><td>1</td><td><b>Venda sem valor no CRM</b> — 1 lead marcado "vendido" sem produto atribuído</td><td>Receita invisível no Analytics e no LTV</td><td>Abrir o card e atribuir a compra</td></tr>
...
<section>
  ...
  <div class="card plan">
    ...
    <div class="item"><span class="prio p0">P0</span><p><b>Atribuir valor à venda órfã no CRM</b> (defeito 1). Um clique no card, e a receita do período para de estar subestimada.</p></div>
    ...
    <div class="item"><span class="prio p1">P1</span><p><b>Decidir o destino da /webinar</b> — reaproveitar com data nova, virar replay ou sair do ar. Hoje ela promete uma aula que já aconteceu.</p></div>
